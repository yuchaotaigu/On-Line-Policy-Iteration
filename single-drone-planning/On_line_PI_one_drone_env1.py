...
Single-file experiment for CDC submission.

Pipeline:
  1. Train initial policy π⁰ via PPO (clipped surrogate, proper algorithm)
...
Cost (stage-wise additive, scaled to ~100-200):
